                            ...
                            <div class="overflow-y-auto">
                                <table class="w-full table-fixed text-sm">
                                    <thead class="sticky top-0 z-10">
                                        <tr>
                                            <th class="px-3 py-2 text-left font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-10 bg-gray-50 dark:bg-gray-800">
                                                Taller</th>
                                            <th class="px-3 py-2 text-left font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-10 bg-gray-50 dark:bg-gray-800">
                                                Horario</th>
                                            <th class="px-3 py-2 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-10 bg-gray-50 dark:bg-gray-800">
                                                Inscritos</th>
                                            <th class="px-3 py-2 text-right font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-10 bg-gray-50 dark:bg-gray-800">
                                                Tarifa Mensual</th>
                                            <th class="px-3 py-2 text-right font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-10 bg-gray-50 dark:bg-gray-800">
                                                    ...
                                                    @if (($workshop['schedule_rowspan'] ?? 1) > 0)
                                                        <td class="px-3 py-2 text-gray-500 dark:text-gray-400 text-xs align-middle"
                                                            ...
                                                            @foreach ($workshop['schedule_modalities'] ?? [] as $mod)
                                                                <div class="text-xs text-indigo-500 dark:text-indigo-400 font-medium mt-0.5">
                                                                    {{ $mod }}</div>
                                                            @endforeach
                                                        </td>
                                                    @endif
                    ...
                    <div x-show="tab === 'hourly'" x-cloak class="mt-4">
                        <div class="relative rounded-lg border border-gray-200 dark:border-gray-700">
                            <table class="w-full table-auto text-sm">
                                <thead>
                                    <tr>
                                        <th class="px-3 py-2 text-left font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                            Taller</th>
                                        <th class="px-3 py-2 text-left font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                            Horario</th>
                                        <th class="px-3 py-2 text-center font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                            Inscritos</th>
                                        <th class="px-3 py-2 text-right font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                            Tarifa Mensual</th>
                                        <th class="px-3 py-2 text-center font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                            Horas</th>
                                        <th class="px-3 py-2 text-center font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
                                        ...
                                        @foreach ($instructor['workshops'] as $workshop)
                                            ...
                                            <tr class="{{ $schedGroupIdx % 2 === 1 ? 'ipr-row-odd' : 'ipr-row-even' }}">
                                                ...
                                                <td class="px-3 py-2 text-right text-gray-600 dark:text-gray-300">S/
                                                    {{ number_format($workshop['standard_fee'], 2) }}</td>
                                                @if (($workshop['schedule_rowspan'] ?? 1) > 0)
                                                    <td class="px-3 py-2 text-center text-gray-900 dark:text-white align-middle"
                                                        rowspan="{{ $workshop['schedule_rowspan'] }}">
                                                        {{ number_format($workshop['hours_worked'], 1) }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center text-green-600 dark:text-green-400 font-medium align-middle"
                                                        rowspan="{{ $workshop['schedule_rowspan'] }}">
                                                        S/ {{ number_format($workshop['hourly_rate'], 2) }}
                                                    </td>
                                                    <td class="px-3 py-2 text-right font-semibold text-green-600 dark:text-green-400 align-middle"
                                                        rowspan="{{ $workshop['schedule_rowspan'] }}">
