                                ...
                                <tr class="{{ $schedGroupIdx % 2 === 1 ? 'ipr-row-odd' : 'ipr-row-even' }}">
                                    ...
                                    <td class="px-3 py-2 text-gray-500 dark:text-gray-400 text-xs align-middle" rowspan="{{ $workshop['schedule_rowspan'] }}">
                                        ...
                                        @foreach($workshop['schedule_modalities'] ?? [] as $mod)
                                            <div class="text-xs text-indigo-500 dark:text-indigo-400 font-medium mt-0.5">{{ $mod }}</div>
                                        @endforeach
                                    </td>
                                    @endif
                                    <td class="px-3 py-2 text-center text-gray-900 dark:text-white">
                                        ...
                                        @if(!empty($workshop['class_count']))
                                            <div class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{{ $workshop['class_count'] }}c</div>
                                        @endif
                                    </td>
