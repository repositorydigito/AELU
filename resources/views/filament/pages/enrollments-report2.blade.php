                ...
                <table class="w-full table-auto">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                            ...
                            <td class="px-4 py-4 text-sm text-gray-900 dark:text-white">{{ $enrollment['birth_date'] }}</td>
                            <td class="px-4 py-4 text-sm text-gray-900 dark:text-white">{{ $enrollment['age'] }}</td>
